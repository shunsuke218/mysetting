...
(set-language-environment "Japanese")(setenv "LANG" "ja_JP.UTF-8")
...
(require 'quickrun)
;;(load-file /home/shaga/.emacs.d/quickrun.el)
(global-set-key (kbd "s-g") 'quickrun)
...
;; Using mozc to allow Japanese input
(global-set-key (kbd "<M-SPC>") 'toggle-input-method)
(global-set-key (kbd "M-SPC") 'toggle-input-method)
(global-set-key (kbd "<s-SPC>") 'toggle-input-method)
(global-set-key (kbd "<H-SPC> ") 'toggle-input-method)
;;(global-set-key (kbd "s-H-SPC") 'toggle-input-method)
(require 'mozc)
